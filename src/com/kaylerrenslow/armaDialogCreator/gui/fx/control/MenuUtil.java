...
import com.kaylerrenslow.armaDialogCreator.gui.fx.action.ActionEventWrapper;
...
public class MenuUtil {
	 ...
	 */
	public static void addListeners(IActionEventHandler handler, @NotNull Menu... menus) {
		ObservableList<MenuItem> menuItems;
		for (Menu menu : menus) {
			menuItems = menu.getItems();
			for (MenuItem item : menuItems) {
				item.setOnAction(new ActionEventWrapper(handler, item));
			}
		}
	}
}
