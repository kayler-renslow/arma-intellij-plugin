...
class CanvasControls extends VBox implements IPositionCalculator {
	...
	private final String folderUrl = "/com/kaylerrenslow/armaDialogCreator/icons/folder.png";
	...
	CanvasControls(CanvasView canvasView) {
		...
		hboxStep.getChildren().addAll(lblAltStep, cbAltStep, lblStep, cbStep);
	...
	private void doThings() {
		...
		//			}
		//		});
		//		TreeViewMenuItemBuilder.setNewItemAction(treeView, newItem, "New Item", new Object(), null);
	...
	private ImageView createFolderIcon() {
		return new ImageView(folderUrl);
	}
