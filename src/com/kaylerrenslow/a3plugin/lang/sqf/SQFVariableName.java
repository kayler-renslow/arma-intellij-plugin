...
/**
 * Utility class for variable names in SQF. For SQF in Arma 3, variable names aren't case sensitive. Instead of passing around {@link String} and doing {@link String#equalsIgnoreCase(String)} everywhere,
