...
public class SQFStatic{
	...
	public static final String COMMANDS_DOC_FILE_DIR = "/com/kaylerrenslow/plugin/lang/sqf/commands-doc/";
	...
	public static final String SQF_SAMPLE_CODE_TEXT = FileReader.getInstance().getText("/com/kaylerrenslow/a3plugin/lang/sqf/codeStyle/sqfSampleCode.sqf");
}
