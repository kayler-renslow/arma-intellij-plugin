...
public class HeaderPreIncludeFileImpl extends ASTWrapperPsiElement implements HeaderPreIncludeFile {

  public HeaderPreIncludeFileImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HeaderVisitor visitor) {
    visitor.visitPreIncludeFile(this);
  }
