...
public class HeaderPreUndefImpl extends ASTWrapperPsiElement implements HeaderPreUndef {

  public HeaderPreUndefImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HeaderVisitor visitor) {
    visitor.visitPreUndef(this);
  }
