...
public class HeaderPreDefineImpl extends ASTWrapperPsiElement implements HeaderPreDefine {

  public HeaderPreDefineImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HeaderVisitor visitor) {
    visitor.visitPreDefine(this);
  }
