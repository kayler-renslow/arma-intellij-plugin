...
public class HeaderClassContentImpl extends ASTWrapperPsiElement implements HeaderClassContent {

  public HeaderClassContentImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HeaderVisitor visitor) {
    visitor.visitClassContent(this);
  }
  ...
  @Override
  @NotNull
  public HeaderFileEntries getFileEntries() {
    return findNotNullChildByClass(HeaderFileEntries.class);
  }
