...
public class SQFCommandExpressionImpl extends SQFExpressionImpl implements SQFCommandExpression {
  ...
  public String getCommandName() {
    return SQFPsiImplUtilForGrammar.getCommandName(this);
  }

  @Nullable
  public PsiElement getPrefixArgument() {
    return SQFPsiImplUtilForGrammar.getPrefixArgument(this);
  }

  @Nullable
  public PsiElement getPostfixArgument() {
    return SQFPsiImplUtilForGrammar.getPostfixArgument(this);
  }
