...
import com.kaylerrenslow.armaplugin.lang.sqf.psi.SQFCodeBlock;
import com.kaylerrenslow.armaplugin.lang.sqf.psi.*;

public class SQFPsiCodeBlockImpl extends SQFCodeBlock implements SQFPsiCodeBlock {

  public SQFPsiCodeBlockImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SQFPsiLocalScope getLocalScope() {
    return findChildByClass(SQFPsiLocalScope.class);
  }
