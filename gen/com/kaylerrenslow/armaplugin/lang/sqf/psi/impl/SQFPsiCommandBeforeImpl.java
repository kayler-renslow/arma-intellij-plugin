...
public class SQFPsiCommandBeforeImpl extends SQFCommandArgument implements SQFPsiCommandBefore {

  public SQFPsiCommandBeforeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SQFPsiVisitor visitor) {
    visitor.visitCommandBefore(this);
  }
