...
import com.kaylerrenslow.armaplugin.lang.sqf.psi.SQFConfigFetchExpression;
import com.kaylerrenslow.armaplugin.lang.sqf.psi.*;

public class SQFPsiConfigFetchExpressionImpl extends SQFConfigFetchExpression implements SQFPsiConfigFetchExpression {

  public SQFPsiConfigFetchExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SQFPsiVisitor visitor) {
    visitor.visitConfigFetchExpression(this);
  }
