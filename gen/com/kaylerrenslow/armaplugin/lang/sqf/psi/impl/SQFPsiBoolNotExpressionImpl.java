...
import com.kaylerrenslow.armaplugin.lang.sqf.psi.SQFBoolNotExpression;
import com.kaylerrenslow.armaplugin.lang.sqf.psi.*;

public class SQFPsiBoolNotExpressionImpl extends SQFBoolNotExpression implements SQFPsiBoolNotExpression {

  public SQFPsiBoolNotExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SQFPsiVisitor visitor) {
    visitor.visitBoolNotExpression(this);
  }
