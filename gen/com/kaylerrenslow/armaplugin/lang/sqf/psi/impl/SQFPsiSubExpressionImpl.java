...
import com.kaylerrenslow.armaplugin.lang.sqf.psi.SQFSubExpression;
import com.kaylerrenslow.armaplugin.lang.sqf.psi.*;

public class SQFPsiSubExpressionImpl extends SQFSubExpression implements SQFPsiSubExpression {

  public SQFPsiSubExpressionImpl(ASTNode node) {
    super(node);
  }
