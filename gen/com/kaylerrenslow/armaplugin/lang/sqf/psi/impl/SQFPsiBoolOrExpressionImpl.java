...
import com.kaylerrenslow.armaplugin.lang.sqf.psi.SQFBoolOrExpression;
import com.kaylerrenslow.armaplugin.lang.sqf.psi.*;

public class SQFPsiBoolOrExpressionImpl extends SQFBoolOrExpression implements SQFPsiBoolOrExpression {

  public SQFPsiBoolOrExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SQFPsiVisitor visitor) {
    visitor.visitBoolOrExpression(this);
  }
